...
export const Footer = () => {
  return (
    <footer className="relative border-t border-border/50 py-16 px-6 overflow-hidden">
      ...
      {/* Subtle aurora glow at footer */}
      <div className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-gradient-to-t from-accent/10 to-transparent blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid md:grid-cols-5 gap-8 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-xs">
              Empowering designers with intelligent creative tools. Build faster, design smarter.
            </p>
            {/* Newsletter */}
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} AIKO. All rights reserved.</p>
          <div className="flex gap-6">
            <a href="#" className="hover:text-foreground transition-all hover:-translate-y-0.5 inline-block" aria-label="Twitter">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="#" className="hover:text-foreground transition-all hover:-translate-y-0.5 inline-block" aria-label="GitHub">
            ...
            <a href="#" className="hover:text-foreground transition-all hover:-translate-y-0.5 inline-block" aria-label="LinkedIn">
